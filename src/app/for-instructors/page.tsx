...
const audiences = [
  ...
  "集客・SNS・マーケティングなど、売上につなげる施策に強い方",
  "税務・労務・法務など、サロン経営を支える専門家の方",
  "人材育成・マネジメント・コーチングで現場支援の経験がある方",
];
...
const faqs = [
  {
    ...
    a: "講師申込はサイト内アンケート（未ログイン）からお送りください。美容師会員登録（研修受講）とは別の手続きです。承認後、運営が講師として公開します。",
  },
  {
    q: "報酬体系はどうなりますか？",
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-16 sm:px-6 sm:pb-28 sm:pt-20 lg:px-8 lg:pb-36">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-center text-sm text-brand-100/85">
              アンケートは未ログインで送信できます。美容師会員登録とは別の手続きです。
              <br className="hidden sm:block" />
              送信後、ご記入の連絡方法で運営からご連絡します。
            </p>
          </div>
        </div>
      </section>
